...
Image* BatteryStatus(Image* scrbuf,Image* battery0,Image* battery1,Image* battery2,Image* battery3,int BatteryPercent)
{
	...
	*/
	...
	{
		imageDrawSectionAlpha(0,0,Skin_Battery_Width,Skin_Battery_Height,battery0,Skin_Battery_X,Skin_Battery_Y);
	}
	if(BatteryPercent >= 10 && BatteryPercent < 33) 
	{
		imageDrawSectionAlpha(0,0,Skin_Battery_Width,Skin_Battery_Height,battery1,Skin_Battery_X,Skin_Battery_Y);
	}
	if(BatteryPercent >= 33 && BatteryPercent < 66) 
	{
		imageDrawSectionAlpha(0,0,Skin_Battery_Width,Skin_Battery_Height,battery2,Skin_Battery_X,Skin_Battery_Y);
	}
	if(BatteryPercent >= 66 && BatteryPercent <= 100) 
	{
		imageDrawSectionAlpha(0,0,Skin_Battery_Width,Skin_Battery_Height,battery3,Skin_Battery_X,Skin_Battery_Y);
	}
	return screenbuffer;
}
    ...
    if(eq_delay == 2)
    {
      for( x = 0; x < 32 ; x++)
      {
        if(simple_spectrum_full[258 + x] == 0)
          screenDrawFilledRect(0xFFFFFFFF, 99 + (x * 9), 247 - 1  , 5 , 1);
        else      
          screenDrawFilledRect(0xFFFFFFFF, 99 + (x * 9), 247 - (simple_spectrum_full[258 + x] * 2)  , 5 , (simple_spectrum_full[258 + x] * 2));
    ...
    else
    {
      for( x = 0; x < 32 ; x++)
      {
        if(simple_spectrum_bands[x] == 0)
          ...
          screenDrawFilledRect(0xFFFFFFFF, 99 + (x * 9), 247 - (simple_spectrum_bands[x] * 2)  , 5 , (simple_spectrum_bands[x] * 2));
...
*/
  ...
  if(( spectrum_active == 2 ) || ( spectrum_active == 3))
  {
    for(x = 0; x < 289; x++ )
    {
      ...
      screenDrawLine((96 + (x )), (142 + x1) , (97 + (x )), (142 + x2),0xFFFFFFFF);
...
int main() 
{
  ...
  int w,xx,yy;
	...
	Image* sfondo;
	Image* battery0 = imageLoadPNG("v3skin\\data\\static\\battery0.png");
	Image* battery1 = imageLoadPNG("v3skin\\data\\static\\battery1.png");
	Image* battery2 = imageLoadPNG("v3skin\\data\\static\\battery2.png");
	Image* battery3 = imageLoadPNG("v3skin\\data\\static\\battery3.png");
	Image* upmask =   imageLoadPNG("v3skin\\data\\static\\upmask.png");
	Image* credits =  imageLoadPNG("v3skin\\data\\static\\credits.png");
	Image* img_playlist = imageCreate(Skin_Filelist_Width,Skin_Filelist_Height);
	//bg_vis = createImage(480,272)
	screenbuffer = imageCreate(480,272);	  
	
	Image* osc_off   = imageLoadPNG("v3skin\\data\\buttons\\oscilloscope1.png");
	Image* osc_on    = imageLoadPNG("v3skin\\data\\buttons\\oscilloscope2.png");
	Image* eq_off    = imageLoadPNG("v3skin\\data\\buttons\\equalizer1.png");
	Image* eq_on     = imageLoadPNG("v3skin\\data\\buttons\\equalizer2.png");
	Image* both_off  = imageLoadPNG("v3skin\\data\\buttons\\both1.png");
	Image* both_on   = imageLoadPNG("v3skin\\data\\buttons\\both2.png");

  Image* norm_off  = imageLoadPNG("v3skin\\data\\buttons\\normal1.png");
  Image* norm_on   = imageLoadPNG("v3skin\\data\\buttons\\normal2.png");
  Image* shuff_off = imageLoadPNG("v3skin\\data\\buttons\\shuffle1.png");
  Image* shuff_on  = imageLoadPNG("v3skin\\data\\buttons\\shuffle2.png");
  Image* rep_off   = imageLoadPNG("v3skin\\data\\buttons\\repeat1.png");
  Image* rep_on    = imageLoadPNG("v3skin\\data\\buttons\\repeat2.png");

  Image* eq_base   = imageLoadPNG("v3skin\\data\\dynamic\\equalizer_base.png");
//  Image* eq_base_a = imageLoadPNG("v3skin\\data\\dynamic\\equalizer_base2.png");
  
  Image* osc_base   = imageLoadPNG("v3skin\\data\\dynamic\\oscilloscope_base.png");
  Image* osc_left   = imageLoadPNG("v3skin\\data\\dynamic\\oscilloscope_part1.png");
  Image* osc_right  = imageLoadPNG("v3skin\\data\\dynamic\\oscilloscope_part2.png");
		...
		switch(mode)
              {
                case 0: // NORMAL
                  ...
                  imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,norm_on  ,Skin_Buttons_FromLeft,Skin_Button_1_Y);
                  imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,shuff_off ,Skin_Buttons_FromLeft,(Skin_Button_1_Y+Skin_Buttons_Height+Skin_Button_1_Step));
                  imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,rep_off    ,Skin_Buttons_FromLeft,(Skin_Button_1_Y+(2*(Skin_Buttons_Height+Skin_Button_1_Step))));
                  
                  break;

                case  1: // SHUFFLE

                  imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,norm_off  ,Skin_Buttons_FromLeft,Skin_Button_1_Y);
                  imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,shuff_on ,Skin_Buttons_FromLeft,(Skin_Button_1_Y+Skin_Buttons_Height+Skin_Button_2_Step));
                  imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,rep_off    ,Skin_Buttons_FromLeft,(Skin_Button_1_Y+(2*(Skin_Buttons_Height+Skin_Button_1_Step))));
                ...
                case 2: // REPEAT
                  ...
                  imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,norm_off  ,Skin_Buttons_FromLeft,Skin_Button_1_Y);
                  imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,shuff_off ,Skin_Buttons_FromLeft,(Skin_Button_1_Y+Skin_Buttons_Height+Skin_Button_2_Step));
                  imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,rep_on    ,Skin_Buttons_FromLeft,(Skin_Button_1_Y+(2*(Skin_Buttons_Height+Skin_Button_1_Step))));
   ...
   void showSpectrum1(int spectrumActive)
     {
          ...
          {
            case 0:
              imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,eq_off  ,Skin_Buttons_FromLeft,Skin_Button_2_Y); 
              imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,osc_off ,Skin_Buttons_FromLeft,(Skin_Button_2_Y+Skin_Buttons_Height+Skin_Button_2_Step)); 
              imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,both_off,Skin_Buttons_FromLeft,(Skin_Button_2_Y+(2*(Skin_Buttons_Height+Skin_Button_2_Step))));
              break;
              
            case 1:
              imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,eq_on   ,Skin_Buttons_FromLeft,Skin_Button_2_Y);
              imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,osc_off ,Skin_Buttons_FromLeft,(Skin_Button_2_Y+Skin_Buttons_Height+Skin_Button_2_Step));
              imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,both_off,Skin_Buttons_FromLeft,(Skin_Button_2_Y+(2*(Skin_Buttons_Height+Skin_Button_2_Step))));
              break;
            ...
            case 2:
              imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,eq_off  ,Skin_Buttons_FromLeft,Skin_Button_2_Y);
              imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,osc_on  ,Skin_Buttons_FromLeft,(Skin_Button_2_Y+Skin_Buttons_Height+Skin_Button_2_Step));
              imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,both_off,Skin_Buttons_FromLeft,(Skin_Button_2_Y+(2*(Skin_Buttons_Height+Skin_Button_2_Step))));
              break;
            ...
            case 3: 
              imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,eq_off  ,Skin_Buttons_FromLeft,Skin_Button_2_Y);
              imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,osc_off ,Skin_Buttons_FromLeft,(Skin_Button_2_Y+Skin_Buttons_Height+Skin_Button_2_Step));
              imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,both_on ,Skin_Buttons_FromLeft,(Skin_Button_2_Y+(2*(Skin_Buttons_Height+Skin_Button_2_Step))));
              break;
          }
      }     
     
//  Image* osc_base_a = imageLoadPNG("v3skin\\data\\dynamic\\oscilloscope_base2.png");
...
*/  
  ...
  time_ypos = 237;
	...
	/*for(k = 0; k < 10; k++)
	{
		...
		//bar[k] = imageLoadPNG(nFile);
	}*/

	Stampa_Elenco_Files();
	sfondo = imageLoadPNG("v3skin\\data\\static\\sfondo.png");
	playlist = imageLoadPNG("v3skin\\data\\dynamic\\filelist.png");
 ...
 if (SPLASH_ENABLE)
  ...
  Image*  splash = imageLoadPNG("v3skin\\data\\static\\splashscreen.png");
  
  screenClear(BLACK);
  imagePrintText(276,255, "v3 BETA - Not for release", BLACK, splash);
  imageDrawSectionAlpha(0,0,480,272,splash,0,0);
  flipScreen();
...
/*	do
  ...
  */
  ...
  {
    screenClear(BLACK);
    //screenDrawFilledRect(WHITE,0,0,480,272);
    for(xx = 0 ; xx < 480; xx++)
      for(yy = 0 ; yy < 272; yy++)
        splash->imageData[splash->imageTextureWidth * yy + xx] = (splash->imageData[splash->imageTextureWidth * yy + xx] & 0x00FFFFFF) + (w << 24);
	  imageDrawSectionAlpha(0,0,480,272,sfondo,0,0);
	  imageDrawSectionAlpha(0,0,480,272,splash,0,0);
 	  sceDisplayWaitVblankStart();
    flipScreen(); 
  }
 ...
 /*   for(w = 0; w < Skin_Buttons_Width+Skin_Buttons_FromLeft; w+=2)
  ...
  for(w = 0; w < Skin_UpMask_Height; w++)
  {
     screenClear(BLACK);
	 imageDrawSectionAlpha(0,0,480,272,sfondo,0,0);
	 imageDrawSectionAlpha(0,0,480,w,upmask,0,(w-Skin_UpMask_Height));
	 flipScreen();
  }
  ...
  for(w = 0; w < Skin_Buttons_Width+Skin_Buttons_FromLeft; w+=2)
  {
    screenClear(BLACK);
	imageDrawSectionAlpha(0,0,480,272,sfondo,0,0);
	imageDrawSectionAlpha(0,0,480,Skin_UpMask_Height,upmask  ,0,0);
    if(w < Skin_Buttons_Width)
    {
      imageDrawSectionAlpha((Skin_Buttons_Width-w),0,w,Skin_Buttons_Height,norm_off  ,0,Skin_Button_1_Y);
      imageDrawSectionAlpha((Skin_Buttons_Width-w),0,w,Skin_Buttons_Height,eq_off  ,0,Skin_Button_2_Y);      
    }
    else
    {
      imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,norm_off  ,w-Skin_Buttons_Width,Skin_Button_1_Y); 
      imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,eq_off  ,w-Skin_Buttons_Width,Skin_Button_2_Y);      
    } 
 	  //sceDisplayWaitVblankStart();
    flipScreen(); 
  }
  ...
  for(w = 0; w < Skin_Buttons_Width+Skin_Buttons_FromLeft; w+=2)
  {
    ...
    if(w < Skin_Buttons_Width)
    {
      imageDrawSectionAlpha((Skin_Buttons_Width-w),0,w,Skin_Buttons_Height,shuff_off  ,0,(Skin_Button_1_Y+Skin_Buttons_Height+Skin_Button_1_Step));
      imageDrawSectionAlpha((Skin_Buttons_Width-w),0,w,Skin_Buttons_Height,osc_off  ,0,(Skin_Button_2_Y+Skin_Buttons_Height+Skin_Button_2_Step));      
    }
    else
    {
      imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,shuff_off  ,w-Skin_Buttons_Width,(Skin_Button_1_Y+Skin_Buttons_Height+Skin_Button_1_Step)); 
      imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,osc_off  ,w-Skin_Buttons_Width,(Skin_Button_2_Y+Skin_Buttons_Height+Skin_Button_2_Step));      
    } 
  ...
  for(w = 0; w < Skin_Buttons_Width+Skin_Buttons_FromLeft; w+=2)
  {
    ...
    if(w < Skin_Buttons_Width)
    {
      imageDrawSectionAlpha((Skin_Buttons_Width-w),0,w,Skin_Buttons_Height,rep_off  ,0,(Skin_Button_1_Y+(2*(Skin_Buttons_Height+Skin_Button_1_Step))));
      imageDrawSectionAlpha((Skin_Buttons_Width-w),0,w,Skin_Buttons_Height,both_off  ,0,(Skin_Button_2_Y+(2*(Skin_Buttons_Height+Skin_Button_2_Step))));      
    }
    else
    {
      imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,rep_off  ,w-Skin_Buttons_Width,(Skin_Button_1_Y+(2*(Skin_Buttons_Height+Skin_Button_1_Step)))); 
      imageDrawSectionAlpha(0,0,Skin_Buttons_Width,Skin_Buttons_Height,both_off  ,w-Skin_Buttons_Width,(Skin_Button_2_Y+(2*(Skin_Buttons_Height+Skin_Button_2_Step))));      
    } 
	...
	while(1) 
	{
		...
		if(credits_active==0)
		{
         ...
         if(spectrum_active == 1)
         {
              ...
              imageDrawSectionAlpha(0,0,297,48,eq_base,91,200);

              //imageDrawSectionAlpha(0,0,307,74,osc_base ,86,110);
              //blitAlphaImageToImage(0,0,307,74,osc_base_a ,86,110,screenbuffer);
              imageDrawSectionAlpha((148 - eq_y),0,eq_y+1,109,osc_left ,0,88);
              imageDrawSectionAlpha(0,0,eq_y+1,109,osc_right,(480 - (eq_y + 1)),88);            
        		...
        		//imageDrawSectionAlpha(0,0,480,272,screenbuffer,0,0);
        		screenPrintText(time_xpos+1,time_ypos+1, buff, BLACK);
        		screenPrintText(time_xpos  ,time_ypos  , buff, WHITE);
			if(Menu_Mp3==0)
			{
			screenPrintText(Song_Playing_Time_X+1,Song_Playing_Time_Y+1, mp3time, BLACK);
			screenPrintText(Song_Playing_Time_X,Song_Playing_Time_Y, mp3time, WHITE);
			}
              ...
              hub = 1;
                ...
                switch(spectrum_active)
                {
                  ...
                  case 1: // EQ
                    ...
                    imageDrawSectionAlpha(0,0,297,eq_y+1,eq_base,91,(200 + (48 - eq_y)));
                  ...
                  case 3: // BOTH
                    ...
                    imageDrawSectionAlpha(0,0,307,74,osc_base ,86,110);
                    //blitAlphaImageToImage(0,0,307,74,osc_base_a ,86,110,screenbuffer);
                    imageDrawSectionAlpha(0,0,149,109,osc_left ,0,88);
                    imageDrawSectionAlpha(0,0,149,109,osc_right,(480 - 149),88);
                    break;
                }
      ...
      showLeftButtons(play_mode);
			...
			if(Menu_Mp3==1)
			{
				...
				imageDrawSectionAlpha(0,0,Skin_Filelist_Width,Skin_Filelist_Height,img_playlist,72,37);
				playlist_changed=0;
			}
			...
			//screenbuffer=print_video(screenbuffer,songname,350-(count_title),21,-1,1);
			//imageDrawSectionAlpha(0,0,480,44,upmask,0,0);
//			screenbuffer=BatteryStatus(screenbuffer,battery0,battery1,battery2,battery3,BatteryPercent);
			//imageDrawSectionAlpha(0,0,480,272,screenbuffer,0,0);
//			screenPrintText(time_xpos+1,time_ypos+1, buff, BLACK);
//			screenPrintText(time_xpos  ,time_ypos  , buff, WHITE);
      ...
      // SONG SEEKING
		...
		if(credits_active==1)
		{
			//imageDrawSectionAlpha(0,0,480,272,credits,0,0);
			//if(threeDVis) {
			//displayDonut(0);
...
//----------------------------------------------Slide SongTitle----------------------------------------------
		if(song_play==1)
		{
			...
			if(credits_active==0)
			{
				if(Menu_Mp3==0)
				{
				screenPrintText((470-(8*strlen(songname))),48,songname,BLACK);
				screenPrintText((469-(8*strlen(songname))),47,songname,WHITE);
				}
				imageDrawSectionAlpha(0,0,480,Skin_UpMask_Height,upmask,0,0);
				screenbuffer=BatteryStatus(screenbuffer,battery0,battery1,battery2,battery3,BatteryPercent);
				//imageDrawSectionAlpha(0,0,480,272,screenbuffer,0,0);
...
//          screenbuffer=BatteryStatus(screenbuffer,battery0,battery1,battery2,battery3,BatteryPercent);
					imageDrawSectionAlpha(0,0,Skin_Filelist_Width,Skin_Filelist_Height,playlist,x,37);
					if (song_play == 1) 
					{
						MP3_GetTimeString(mp3time);
						//screenbuffer=print_video(screenbuffer,songname,350-(count_title),21,-1,1);
          ...
          showLeftButtons(play_mode);
					...
					imageDrawSectionAlpha(0,0,480,Skin_UpMask_Height,upmask,0,0);
//					imageDrawSectionAlpha(0, 0,2,2,0,0, upmask);
					screenbuffer=BatteryStatus(screenbuffer,battery0,battery1,battery2,battery3,BatteryPercent);
					//imageDrawSectionAlpha(0,0,480,272,screenbuffer,0,0);
...
//------------------------------------------Buttons with active filelist--------------------------------------
    ...
    if(credits_active==0)
    {
      ...
      screenPrintText(307  , 259  , deb_str, BLACK);
      screenPrintText(306  , 258  , deb_str, WHITE);
